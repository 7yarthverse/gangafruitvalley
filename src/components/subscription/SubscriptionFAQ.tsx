...
const faqs = [
  ...
  },
  {
    ...
    answer: "We source the freshest seasonal fruits from trusted local orchards in the Ganga valley region. While not all fruits are certified organic, we prioritize natural farming practices and ensure all produce is thoroughly washed and quality-checked before delivery.",
  },
  {
